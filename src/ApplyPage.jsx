            ...
            <div className="container text-center mb-4">
               <div className="row" style={{ alignItems: 'center' }}>
                  <div className="col-md-6">
                     ...
                     >
                        Avenrider : Get cutomers for Car, boat, Ambulance and
                        Delivery
                     </h1>
                  </div>
                  <div className="col-md-6">
               ...
               <div className="row" style={{ alignItems: 'center' }}>
                  <div className="col-md-6" style={{ textAlign: 'right' }}>
                     ...
                     >
                        ...
                        >
                           Just tap the app Book where and when you want to ride
                           and use your app to go online. When online, you can
                           see if there any rides available or not. If it is
                           green then you can go forward.
                        </p>
                     </div>
                  </div>
            ...
            <div className="container">
               <div className="row mt-4 pt-4">
                  <div className="col-md-4 p-3">
                     <img
                        src={`${process.env.PUBLIC_URL}/images/icons/1.svg`}
                        alt=""
                        className="img-fluid"
                     />
                     <h1>Competitive fees</h1>
                     <p>
                        We pay a competitive fee for each order you deliver. You
                        can earn tips from customers too, to help towards your
                        earnings goals.
                     </p>
                  </div>
                  <div className="col-md-4 p-3">
                     <img
                        src={`${process.env.PUBLIC_URL}/images/icons/2.svg`}
                        alt=""
                        className="img-fluid"
                     />
                  ...
                  <div className="col-md-4 p-3">
                     <img
                        src={`${process.env.PUBLIC_URL}/images/icons/3.svg`}
                        alt=""
                        className="img-fluid"
                     />
                     ...
                     <p>
                        ...
                        training and equipment, too, as well as free accident
                        cover when you’re on the road.
                     </p>
                  </div>
               </div>
               <div className="row mt-4 pt-4">
                  <div className="col-md-4 p-3">
                     <img
                        src={`${process.env.PUBLIC_URL}/images/icons/4.svg`}
                        alt=""
                        className="img-fluid"
                     />
                  ...
                  <div className="col-md-4 p-3">
                     <img
                        src={`${process.env.PUBLIC_URL}/images/icons/5.svg`}
                        alt=""
                        className="img-fluid"
                     />
                     <h1>Free professional kit</h1>
                     <p>
                        Highly visible, comfortable and breathable gear,
                        suitable for the climate you’re riding in.
                     </p>
                  </div>
                  <div className="col-md-4 p-3">
                     <img
                        src={`${process.env.PUBLIC_URL}/images/icons/6.svg`}
                        alt=""
                        className="img-fluid"
                     />
                     <h1>1000s of restaurant partners</h1>
                     <p>
                        We’re one of the busiest food delivery platforms in the
                        country, delivering orders in your local area every day.
                     </p>
                  </div>
               </div>
            </div>
         ...
         <section className="section-layout">
            <div className="container">
               ...
               <div className="section3-subtitle">
                  Once you’ve joined Avenride, here’s what to expect.
               </div>
               <div className="row mt-4 pt-4">
                  <div className="col-md-4">
                     <div>
                        <div
                           ...
                           style={{ maxWidth: '16.25rem', marginRight: '1rem' }}
                        >
                           <img
                              alt=""
                              src={`${process.env.PUBLIC_URL}/images/how1.png`}
                              style={{ maxWidth: '17.5rem', display: 'block' }}
                           />
                        </div>
                        <span className="slide__order">1</span>
                        <h3 className="section4-head">
                           Riders List which will ride with you
                        </h3>
                        <div>
                           <p>
                              Here you will have a list of riders which you will
                              take along with you.
                           </p>
                        </div>
                     </div>
                  ...
                  <div className="col-md-4">
                     <div>
                        ...
                        >
                           <img
                              alt=""
                              src={`${process.env.PUBLIC_URL}/images/how3.png`}
                              style={{ maxWidth: '19.7rem', display: 'block' }}
                           />
                        </div>
                        <span className="slide__order">2</span>
                        <h3 className="section4-head">
                           Select Riders to add them to your list
                        </h3>
                        <div>
                           <p>
                              You'll see a list of customer through which you
                              can select which one you want to take along with
                              you ride.
                           </p>
                        </div>
                     </div>
                  ...
                  <div className="col-md-4">
                     <div>
                        ...
                        >
                           <img
                              alt=""
                              src={`${process.env.PUBLIC_URL}/images/gow2.png`}
                              style={{ maxWidth: '17.5rem', display: 'block' }}
                           />
                        </div>
                        ...
                        <div>
                           <p>
                              Click on it see the customer location on map and
                              go there tp pick them up.
                           </p>
                        </div>
                     </div>
                  </div>
